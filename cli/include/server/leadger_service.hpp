 ...
 * @LastEditors: Leo
 * @LastEditTime: 2022-02-08 23:37:31
 */

#pragma once
#ifndef CLI_INCLUDE_SERVICE_LEADGER_SERVICE_HPP_
#define CLI_INCLUDE_SERVICE_LEADGER_SERVICE_HPP_
...
class LeadgerClient {
public:
  LeadgerClient(std::shared_ptr<grpc::Channel> channel)
      : stub_(ledger_engine::LedgerService::NewStub(channel)){};
  ~LeadgerClient() = default;
...
#endif // CLI_INCLUDE_SERVICE_LEADGER_SERVICE_HPP_