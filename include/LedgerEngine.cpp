...
// Delete
std::optional<common::Error> LedgerEngine::Delete() { return std::nullopt; }

// Purge
std::optional<common::Error> LedgerEngine::Purge() { return std::nullopt; }

// Hide
std::optional<common::Error> LedgerEngine::Hide() { return std::nullopt; }
