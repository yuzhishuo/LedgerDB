 ...
 * @LastEditTime: 2022-02-10 09:42:05
 * @LastEditors: Leo
...
class IStorage : public yuzhi::store::IOnlyReadStore {
...
public:
  ...
  virtual std::optional<Error> delete_key
      [[noreturn]] (const std::string &key) override final {
