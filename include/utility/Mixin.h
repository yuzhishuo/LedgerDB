 ...
 * @LastEditTime: 2022-07-22 09:51:25
 * @LastEditors: Leo
...
template <typename T, typename... Mixins> class Mixin : public T, public Mixins...
{
...
public:
  template <typename... Args> Mixin(Args &&... args) : T{args...}, Mixins{this}... {}
};
