...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_merkle_5fengine_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
::PROTOBUF_NAMESPACE_ID::uint8* LeafMeta::_InternalSerialize(
